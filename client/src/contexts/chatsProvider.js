...
export function ChatsProvider({ login, children }) {
  ...
  const addMessageToConversation = useCallback(
    ({ recipients, message, sender, timeStamp }) => {
      setChats((prevChats) => {
  ...
  function sendMessage(recipients, message, timeStamp) {
    socket.emit("send-message", { recipients, message, timeStamp });
    addMessageToConversation({ recipients, message, sender: login, timeStamp });
  }
